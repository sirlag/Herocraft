...
<NavigationMenu.Root class="container py-2 mx-auto px-6 md:px-8 grid h-16 grid-cols-[auto_1fr_minmax(360px,640px)_1fr_auto] items-center gap-2">
			<div>
				<ul>
					<li
	...
	<div class="justify-self-start">
			...
			<div class="justify-self-center">
				...
				>
					...
					<kbd class="ml-2 hidden md:inline-flex h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground">
						/
					</kbd>
				</button>
			</div>
