	...
	<ul>
		...
		<li>
			<p>
				...
				or &quot;Our&quot; in this Agreement) refers to Herocraft.
			</p>
		</li>
		<li>
			<p>
		...
		<li>
			<p>
				<strong>Website</strong> refers to Herocraft, accessible from
				<a href="http://herocraft.app" rel="external nofollow noopener" target="_blank"
					>http://herocraft.app</a
				>
			</p>
		</li>
		<li>
