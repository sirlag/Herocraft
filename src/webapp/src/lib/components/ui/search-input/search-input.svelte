...
<div
	class={cn( "flex justify-end h-10 rounded-md border border-input bg-background text-sm focus-within:ring-ring focus-within:ring-2 focus-within:ring-offset-2 ring-offset ring-offset-background",
		className
	)}
>
	<input
